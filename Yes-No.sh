...
# https://eupl.eu/
# Program/Design Name:		yes-no.sh
# Description:    shell script to WGET the files to setup and update a cleanand shoiw asking a yes/No question 
# Dependencies:   
# Revision: 
#  
#  Revision 0.02 - Updated 03/18/2024 for SVCTE Mechatronics Class
